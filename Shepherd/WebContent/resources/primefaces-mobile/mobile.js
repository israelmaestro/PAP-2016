...
function(a, c, b){
	if(typeof define === "function" && define.amd){
		...
		(this, document, function(c, b, a, d){
			function(A, J, h, p){
				var I = "virtualMouseBindings", f = "virtualTouchID", e = "vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel"
						.split(" "), z = "clientX clientY pageX pageY screenX screenY"
						.split(" "), F = A.event.mouseHooks ? A.event.mouseHooks.props : [], B = A.event.props
						.concat(F), D = {}, K = 0, v = 0, u = 0, s = false, N = [], k = false, U = false, x = "addEventListener" in h, w = A(h), H = 1, Q = 0;
				A.vmouse = {
				...
				function l(W, X){
					var ae = W.type, af, ad, Y, V, ac, ab, aa, Z;
					W = A.Event(W);
					W.type = X;
					af = W.originalEvent;
					ad = A.event.props;
				...
				function g(Y){
					...
					var W = t(Y).touches[0], V = s, X = A.vmouse.moveDistanceThreshold;
					s = s || Math.abs(W.pageX - v) > X || Math
							.abs(W.pageY - u) > X, flags = S(Y.target);
					if(s && !V){
					...
					return {
						setup : function(Y, X){
							...
							if(x){
								...
								if(D.touchstart === 1){
									w.bind("touchstart", R).bind("touchend", j)
											.bind("touchmove", g)
											.bind("scroll", L)
								}
							}
						...
						teardown : function(Y, X){
							...
							if(x){
								--D.touchstart;
								if(!D.touchstart){
									w.unbind("touchstart", R)
											.unbind("touchmove", g)
											.unbind("touchend", j)
											.unbind("scroll", L)
								}
							}
							var Z = A(this), aa = A.data(this, I);
							if(aa){
								aa[V] = false
							}
							Z.unbind(W, P);
				...
				if(x){
					h
							.addEventListener("click", function(Z){
								var W = N.length, aa = Z.target, ac, ab, ad, Y, V, X;
								if(W){
									ac = Z.clientX;
									ab = Z.clientY;
									...
									while(ad){
										for(Y = 0; Y < W; Y++){
											V = N[Y];
											X = 0;
											if(ad === aa && Math.abs(V.x - ac) < threshold && Math
													.abs(V.y - ab) < threshold || A
													.data(ad, f) === V.touchID){
												Z.preventDefault();
												Z.stopPropagation();
												return
			...
			function(h, k, f){
				var g = "hashchange", n = a, l, m = h.event.special, o = n.documentMode, j = "on" + g in k && (o === f || o > 7);
				function e(p){
					p = p || location.href;
					return "#" + p.replace(/^[^#]*#?(.*)$/, "$1")
				}
					...
					h.browser.msie && !j && function(){
						...
						p.start = function(){
							if(!w){
								x = h.fn[g].src;
								x = x && x + e();
								w = h('<iframe tabindex="-1" title="empty"/>')
						...
						r = function(B, y){
							var A = w.document, z = h.fn[g].domain;
							if(B !== y){
								A.title = n.title;
								A.open();
								z && A
										.write('<script>document.domain="' + z + '"<\/script>');
								A.close();
								w.location.hash = B
							}
						}
			...
			function(f, h){
				...
				f.widget.bridge = function(k, j){
					f.fn[k] = function(n){
						var l = typeof n === "string", m = Array.prototype.slice
								.call(arguments, 1), o = this;
						n = !l && m.length ? f.extend.apply(null, [true, n]
								.concat(m)) : n;
						if(l && n.charAt(0) === "_"){
							return o
						}
				...
				f.Widget.prototype = {
					...
					_createWidget : function(k, l){
						...
						this.element = f(l);
						this.options = f.extend(true, {}, this.options, this
								._getCreateOptions(), k);
						var j = this;
						this.element
					...
					_setOption : function(j, k){
						this.options[j] = k;
						if(j === "disabled"){
							this.widget()[k ? "addClass" : "removeClass"]
					...
					_trigger : function(k, l, m){
						...
						l = f.Event(l);
						l.type = (k === this.widgetEventPrefix ? k : this.widgetEventPrefix + k)
								.toLowerCase();
						m = m || {};
						if(l.originalEvent){
						...
						return !(f.isFunction(o) && o
								.call(this.element[0], l, m) === false || l
								.isDefaultPrevented())
					}
				}
			}(jQuery);
				...
				e
						.widget("mobile.widget", {
							_createWidget : function(){
								e.Widget.prototype._createWidget
							...
							enhanceWithin : function(h, g){
								this
										.enhance(e(this.options.initSelector, e(h)), g)
							},
							enhance : function(j, h){
								var m, l, g = e(j), k = this;
			...
			function(j, h, k){
				...
				j.mobile = j
						.extend({}, {
							...
							nsNormalize : function(l){
								...
								return g[l] || (g[l] = j
										.camelCase(j.mobile.ns + l))
							},
							getInheritedTheme : function(q, n){
								var r = q[0], o = "", p = /ui-(bar|body|overlay)-([a-z])\b/, s, l;
								while(r){
									var s = r.className || "";
									if((l = p.exec(s)) && (o = l[2])){
										break
							...
							haveParents : function(n, r){
								...
								var o = n.length, l = j(), q, t, p;
								for(var m = 0; m < o; m++){
									t = n.eq(m);
									p = false;
									q = n[m];
									while(q){
										var s = q.getAttribute ? q
												.getAttribute("data-" + j.mobile.ns + r) : "";
										if(s === "false"){
											p = true;
											break
										}
				...
				j.fn.jqmData = function(n, m){
					...
					if(typeof n != "undefined"){
						...
						l = this.data
								.apply(this, arguments.length < 2 ? [n] : [n, m])
					}
					return l
				};
			...
			function(f, h){
				...
				f.mobile.media = function(){
					var j = {}, k = f("<div id='jquery-mediatest'>"), l = f("<body>")
							.append(k);
					return function(o){
						if(!o in j){
							var m = a.createElement("style"), n = "@media " + o + " { #jquery-mediatest { position:absolute; } }";
							m.type = "text/css";
							if(m.styleSheet){
			...
			function(l, g){
				var h = l("<body>").prependTo("html"), o = h[0].style, q = [
						"Webkit", "Moz", "O"], r = "palmGetResource" in b, p = b.operamini && {}.toString
						.call(b.operamini) === "[object OperaMini]", n = b.blackberry;
				function f(w){
					var u = w.charAt(0).toUpperCase() + w.substr(1), t = (w + " " + q
							.join(u + " ") + u).split(" ");
					for( var s in t){
						if(o[t[s]] !== g){
							return true
				...
				function j(){
					var s = "transform-3d";
					return k("perspective", "10px", "moz") || l.mobile
							.media("(-" + q.join("-" + s + "),(-") + "-" + s + "),(" + s + ")")
				}
				function e(){
					var w = location.protocol + "//" + location.host + location.pathname + "ui-dir/", v = l("head base"), x = null, s = "", u, t;
					if(!v.length){
						v = x = l("<base>", {
							href : w
						}).appendTo("head")
				...
				l.mobile.browser.ie = function(){
					var t = 3, u = a.createElement("div"), s = u.all || [];
				...
				var m = function(){
					...
					return s.indexOf("Nokia") > -1 && (s.indexOf("Symbian/3") > -1 || s
							.indexOf("Series60/5") > -1) && s
							.indexOf("AppleWebKit") > -1 && s
			...
			function(g, m, e){
				g
						.each("touchstart touchmove touchend orientationchange throttledresize tap taphold swipe swipeleft swiperight scrollstart scrollstop"
								.split(" "), function(p, o){
							g.fn[o] = function(q){
				...
				var h = g.support.touch, j = "touchmove scroll", n = h ? "touchstart" : "mousedown", l = h ? "touchend" : "mouseup", f = h ? "touchmove" : "mousemove";
				function k(r, o, q){
					var p = q.type;
					q.type = o;
				...
				g.event.special.tap = {
					setup : function(){
						...
						p.bind("vmousedown", function(t){
							...
							var s = t.target, q = t.originalEvent, w;
							function r(){
								clearTimeout(w)
							}
							function v(){
				...
				g.event.special.swipe = {
					...
					setup : function(){
						...
						p
								.bind(n, function(r){
									var t = r.originalEvent.touches ? r.originalEvent.touches[0] : r, u = {
									...
									p
											...
											.one(l, function(v){
												p.unbind(f, s);
												if(u && q){
													if(q.time - u.time < g.event.special.swipe.durationThreshold && Math
															.abs(u.coords[0] - q.coords[0]) > g.event.special.swipe.horizontalDistanceThreshold && Math
															.abs(u.coords[1] - q.coords[1]) < g.event.special.swipe.verticalDistanceThreshold){
														u.origin
																.trigger("swipe")
																.trigger(u.coords[0] > q.coords[0] ? "swipeleft" : "swiperight")
													}
												}
												u = q = e
											})
				...
				function(u, y){
					var w = u(y), o, q, v, r, z, x = {
						"0" : true,
						"180" : true
					};
					if(u.support.orientation){
						var t = y.innerWidth || u(y).width(), p = y.innerHeight || u(y)
								.height(), s = 50;
						r = t > p && t - p > s;
						z = x[y.orientation];
						if(r && z || !r && !z){
					...
					u.event.special.orientationchange.orientation = q = function(){
						var C = true, B = a.documentElement;
						if(u.support.orientation){
							C = x[y.orientation]
						}
						else{
			...
			function(e, f){
				e
						.widget("mobile.page", e.mobile.widget, {
							options : {
								theme : "c",
								domCache : false,
							...
							_create : function(){
								...
								g.element
										.attr("tabindex", "0")
										.addClass("ui-page ui-body-" + g.options.theme)
							...
							removeContainerBackground : function(){
								e.mobile.pageContainer
										.removeClass("ui-overlay-" + e.mobile
							...
							setContainerBackground : function(g){
								if(this.options.theme){
									e.mobile.pageContainer
											.addClass("ui-overlay-" + (g || this.options.theme))
								}
							},
							keepNativeSelector : function(){
								var g = this.options, h = g.keepNative && e
										.trim(g.keepNative);
								if(h && g.keepNative !== g.keepNativeDefault){
									return [g.keepNative, g.keepNativeDefault]
											.join(", ")
								}
			...
			function(j, f, k){
				var e = function(l){
					...
					return function(D, u, n, B){
						var C = new j.Deferred(), m = u ? " reverse" : "", s = j.mobile.urlHistory
								.getActive(), y = s.lastScroll || j.mobile.defaultHomeScroll, A = j.mobile
								.getScreenHeight(), p = j.mobile.maxTransitionWidth !== false && j(f)
								.width() > j.mobile.maxTransitionWidth, o = !j.support.cssTransitions || p || !D || D === "none", q = function(){
							j.mobile.pageContainer
									.toggleClass("ui-mobile-viewport-transitioning viewport-" + D)
						}, z = function(){
							j.event.special.scrollstart.enabled = false;
							f.scrollTo(0, y);
							setTimeout(function(){
							...
							B
									.removeClass(j.mobile.activePageClass + " out in reverse " + D)
									.height("")
						}, w = function(){
							if(!l){
								x()
			...
			function(l, n){
				var u = l(b), x = l("html"), r = l("head"), w = {
					...
					makeUrlAbsolute : function(I, K){
						...
						var M = w.parseUrl(I), P = w.parseUrl(K), Q = M.protocol || P.protocol, J = M.protocol ? M.doubleSlash : M.doubleSlash || P.doubleSlash, N = M.authority || P.authority, O = M.pathname !== "", H = w
								.makePathAbsolute(M.pathname || P.filename, P.pathname), R = M.search || !O && P.search || "", L = M.hash;
						return Q + J + N + H + R + L
					},
					addSearchParams : function(I, L){
						var H = w.parseUrl(I), K = typeof L === "object" ? l
								.param(L) : L, J = H.search || "?";
					...
					isFirstPageUrl : function(J){
						var I = w.parseUrl(w.makeUrlAbsolute(J, A)), L = I.hrefNoHash === k.hrefNoHash || f && I.hrefNoHash === A.hrefNoHash, H = l.mobile.firstPage, K = H && H[0] ? H[0].id : n;
						return L && (!I.hash || I.hash === "#" || K && I.hash
								.replace(/^#/, "") === K)
					},
				...
				}, z = "[tabindex],a,button:visible,select:visible,input", t = [], B = false, F = "&ui-state=dialog", q = r
						.children("base"), k = w.parseUrl(location.href), A = q.length ? w
						.parseUrl(w.makeUrlAbsolute(q.attr("href"), k.href)) : k, f = k.hrefNoHash !== A.hrefNoHash;
				...
				u
						.bind(l.support.pushState ? "popstate" : "hashchange", function(){
							s = false
						});
				u
						.one(l.support.pushState ? "popstate" : "hashchange", function(){
							s = true
						});
				...
				function C(J, K, M, H){
					...
					var I = l.mobile.transitionHandlers[M || "default"] || l.mobile.defaultTransitionHandler, L = I(M, H, J, K);
					L.done(function(){
						if(K){
				...
				function e(){
					var I = l("." + l.mobile.activePageClass), J = parseFloat(I
							.css("padding-top")), H = parseFloat(I
							.css("padding-bottom"));
				...
				l.fn.animationComplete = function(H){
					if(l.support.cssTransitions){
						return l(this)
								.one("webkitAnimationEnd animationend", H)
					}
					else{
						setTimeout(H, 0);
						return l(this)
				...
				l.mobile._bindPageRemove = function(){
					var H = l(this);
					if(!H.data("page").options.domCache && H
							.is(":jqmData(external-page='true')")){
						H.bind("pagehide.remove", function(){
							var J = l(this), I = new l.Event("pageremove");
							J.trigger(I);
				...
				l.mobile.loadPage = function(I, V){
					var U = l.Deferred(), J = l
							.extend({}, l.mobile.loadPage.defaults, V), N = null, S = null, M = function(){
					...
					var L = J.pageContainer, T = new l.Event("pagebeforeload"), H = {
						url : I,
						absUrl : K,
						dataUrl : O,
						deferred : U,
						...
						l
								.ajax({
									...
									success : function(Y, ad, ac){
										var Z = l("<div></div>"), W = Y
												.match(/<title[^>]*>([^<]*)/) && RegExp.$1, ab = new RegExp("(<[^>]+\\bdata-" + l.mobile.ns + "role=[\"']?page[\"']?[^>]*>)"), X = new RegExp("\\bdata-" + l.mobile.ns + "url=[\"']?([^\"'>]*)[\"']?");
										if(ab.test(Y) && RegExp.$1 && X
												.test(RegExp.$1) && RegExp.$1){
										...
										N = Z
												...
												.first();
										if(!N.length){
											N = l("<div data-" + l.mobile.ns + "role='page'>" + Y
													.split(/<\/?body[^>]*>/gmi)[1] + "</div>")
										}
										...
										if(!l.support.dynamicBaseTag){
											var aa = w.get(R);
											N
													.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]")
													.each(function(){
														var af = l(this)
																.is("[href]") ? "href" : l(this)
																.is("[src]") ? "src" : "action", ae = l(this)
																.attr(af);
														ae = ae
										...
										N
												.attr("data-" + l.mobile.ns + "url", w
														.convertUrlToDataUrl(R))
												.attr("data-" + l.mobile.ns + "external-page", true)
												.appendTo(J.pageContainer);
										N
												.one("pagecreate", l.mobile._bindPageRemove);
										y(N, J.role);
										if(K
												.indexOf("&" + l.mobile.subPageUrlKey) > -1){
											N = J.pageContainer
													.children(":jqmData(url='" + O + "')")
										}
										if(J.showLoadMsg){
											P()
										}
									...
									error : function(Y, Z, W){
										...
										if(J.showLoadMsg){
											P();
											l.mobile
													.showPageLoadingMsg(l.mobile.pageLoadErrorMessageTheme, l.mobile.pageLoadErrorMessage, true);
				...
				l.mobile.changePage = function(V, X){
					...
					var R = P.pageContainer, L = new l.Event("pagebeforechange"), H = {
						toPage : V,
						options : P
					};
					R.trigger(L, H);
					...
					var J = P.fromPage, I = P.dataUrl && w
							.convertUrlToDataUrl(P.dataUrl) || V
							.jqmData("url"), O = I, U = w.getFilePath(I), N = j
							.getActive(), W = j.activeIndex === 0, K = 0, S = a.title, M = P.role === "dialog" || V
							.jqmData("role") === "dialog";
					...
					try{
						if(a.activeElement && a.activeElement.nodeName
								.toLowerCase() != "body"){
							l(a.activeElement).blur()
						}
						else{
							l("input:focus, textarea:focus, select:focus")
									.blur()
						}
					} catch(T){
					}
					...
					C(V, J, P.transition, P.reverse)
							.done(function(Z, Y, ac, ab, aa){
								D();
				...
				function o(H){
					while(H){
						if(typeof H.nodeName === "string" && H.nodeName
								.toLowerCase() == "a"){
							break
						}
						H = H.parentNode
				...
				function h(J){
					var H = l(J).closest(".ui-page").jqmData("url"), I = A.hrefNoHash;
					if(!H || !w.isPath(H)){
						H = I
					}
				...
				l.mobile._registerInternalEvents = function(){
					l(a).delegate("form", "submit", function(J){
						var L = l(this);
						if(!l.mobile.ajaxEnabled || L
								.is(":jqmData(ajax='false')") || !L
								.jqmHijackable().length){
							return
						}
						var I = L.attr("method"), K = L.attr("target"), H = L
								.attr("action");
						if(!H){
							H = h(L);
							if(H === A.hrefNoHash){
					...
					l(a)
							.bind("vclick", function(I){
								...
								if(H){
									if(w
											.parseUrl(H.getAttribute("href") || "#").hash !== "#"){
										D(true);
										G = l(H).closest(".ui-btn")
												.not(".ui-disabled");
										G.addClass(l.mobile.activeBtnClass);
										l("." + l.mobile.activePageClass + " .ui-btn")
												.not(H).blur();
										l(H).jqmData("href", l(H).attr("href"))
												.attr("href", "#")
									}
								}
							});
					l(a)
							.bind("click", function(I){
								...
								var O = h(P), J = w.makeUrlAbsolute(P
										.attr("href") || "#", O);
								if(!l.mobile.ajaxEnabled && !w
										.isEmbeddedPage(J)){
									L();
									return
								}
								if(J.search("#") != -1){
									...
									if(!J){
										...
										if(w.isPath(J)){
											...
											J = w
													.makeUrlAbsolute("#" + J, k.hrefNoHash)
										}
									}
								}
								var K = P.is("[rel='external']") || P
										.is(":jqmData(ajax='false')") || P
										.is("[target]"), R = l.mobile.allowCrossDomainPages && k.protocol === "file:" && J
										.search(/^https?:/) != -1, H = K || w
										.isExternal(J) && !R;
								if(H){
									L();
									return
								}
								var Q = P.jqmData("transition"), T = P
										.jqmData("direction"), N = T && T === "reverse" || P
										.jqmData("back"), M = P
										.attr("data-" + l.mobile.ns + "rel") || n;
					...
					l(a)
							.delegate(".ui-page", "pageshow.prefetch", function(){
								var H = [];
								l(this)
										.find("a:jqmData(prefetch)")
										.each(function(){
											var I = l(this), J = I.attr("href");
											if(J && l.inArray(J, H) === -1){
												H.push(J);
												l.mobile
														.loadPage(J, {
															role : I
																	.attr("data-" + l.mobile.ns + "rel")
														})
											}
										})
							});
					l.mobile._handleHashChange = function(I){
						var K = w.stripHash(I), J = l.mobile.urlHistory.stack.length === 0 ? "none" : n, H = {
							transition : J,
							changeHash : false,
							fromHashChange : true
						};
						...
						if(K){
							K = typeof K === "string" && !w.isPath(K) ? w
									.makeUrlAbsolute("#" + K, A) : K;
			...
			function(j, h){
				var g = {}, e = g, k = j(h), f = j.mobile.path
				...
				j
						.extend(g, {
							...
							resetUIKeys : function(m){
								var n = j.mobile.dialogHashKey, l = "&" + j.mobile.subPageUrlKey, o = m
										.indexOf(n);
								if(o > -1){
							...
							onHashChange : function(p){
								...
								var l, m, o = location.hash, q = j.mobile.path
										.isPath(o), n = q ? location.href : j.mobile
										.getDocumentUrl();
								o = q ? o.replace("#", "") : o;
								m = e.state();
							...
							onPopState : function(p){
								var m = p.originalEvent.state, o, q, n, l;
								if(m){
									q = e
											.hashValueAfterReset(j.mobile.urlHistory
													.getActive().url);
									n = e.hashValueAfterReset(m.hash
											.replace("#", ""));
									l = q !== n;
									if(l){
										k
												.one("hashchange.pushstate", function(){
													e
															.nextHashChangePrevented(false)
												})
									}
							...
							init : function(){
								...
								if(location.hash === ""){
									history
											.replaceState(e.state(), a.title, location.href)
								}
							}
						});
				j(function(){
			...
			function(e, f){
				...
				e(a)
						.bind("pagecreate create", function(j){
							var h = e.mobile.closestPageData(e(j.target)), g;
							if(!h){
								return
							}
							g = h.options;
							e(j.target)
									.find("input")
									.not(h.keepNativeSelector())
									.each(function(){
										var q = e(this), p = this
												.getAttribute("type"), l = g.degradeInputs[p] || "text";
										if(g.degradeInputs[p]){
											var o = e("<div>").html(q.clone())
													.html(), k = o
													.indexOf(" type=") > -1, n = k ? /\s+type=["']?\w+['"]?/ : /\/?>/, m = ' type="' + l + '" data-' + e.mobile.ns + 'type="' + p + '"' + (k ? "" : ">");
			...
			function(f, e, g){
				f
						.widget("mobile.dialog", f.mobile.widget, {
							options : {
								closeBtnText : "Close",
								overlayTheme : "a",
							...
							_create : function(){
								var j = this, k = this.element, h = f("<a href='#' data-" + f.mobile.ns + "icon='delete' data-" + f.mobile.ns + "iconpos='notext'>" + this.options.closeBtnText + "</a>"), l = f("<div/>", {
									role : "dialog",
									"class" : "ui-dialog-contain ui-corner-all ui-overlay-shadow"
								});
								k
										.addClass("ui-dialog ui-overlay-" + this.options.overlayTheme);
								k.wrapInner(l).children()
										.find(":jqmData(role='header')")
										.prepend(h).end()
										.children(":first-child")
										.addClass("ui-corner-top").end()
										.children(":last-child")
								...
								k
										.bind("vclick submit", function(n){
											var m = f(n.target)
													.closest(n.type === "vclick" ? "a" : "form"), o;
											if(m.length && !m
													.jqmData("transition")){
												o = f.mobile.urlHistory
														.getActive() || {};
												m
														.attr("data-" + f.mobile.ns + "transition", (o.transition || f.mobile.defaultDialogTransition))
														.attr("data-" + f.mobile.ns + "direction", "reverse")
											}
										})
										.bind("pagehide", function(n, m){
											f(this)
													.find("." + f.mobile.activeBtnClass)
													.removeClass(f.mobile.activeBtnClass)
										})
										.bind("pagebeforeshow", function(){
											if(j.options.overlayTheme){
												j.element
														.page("removeContainerBackground")
														.page("setContainerBackground", j.options.overlayTheme)
											}
										})
							},
							close : function(){
				...
				f(a)
						.delegate(f.mobile.dialog.prototype.options.initSelector, "pagecreate", function(){
			...
			function(e, f){
				...
				e(a).bind("pagecreate create", function(g){
					e(":jqmData(role='fieldcontain')", g.target)
			...
			function(e, f){
				e.fn.grid = function(g){
					return this.each(function(){
						...
						p.filter(":nth-child(" + j + "n+1)")
								.addClass("ui-block-a");
						if(j > 1){
							p.filter(":nth-child(" + j + "n+2)")
									.addClass("ui-block-b")
						}
						if(j > 2){
			...
			function(f, g){
				f.fn.buttonMarkup = function(x){
					...
					for(var l = 0; l < q.length; l++){
						var k = q.eq(l), n = k[0], j = f
								.extend({}, f.fn.buttonMarkup.defaults, {
									icon : x.icon !== g ? x.icon : k
											.jqmData("icon"),
									iconpos : x.iconpos !== g ? x.iconpos : k
											.jqmData("iconpos"),
									theme : x.theme !== g ? x.theme : k
											.jqmData("theme") || f.mobile
											.getInheritedTheme(k, "c"),
									inline : x.inline !== g ? x.inline : k
											.jqmData("inline"),
									shadow : x.shadow !== g ? x.shadow : k
											.jqmData("shadow"),
									corners : x.corners !== g ? x.corners : k
											.jqmData("corners"),
									iconshadow : x.iconshadow !== g ? x.iconshadow : k
											.jqmData("iconshadow"),
									mini : x.mini !== g ? x.mini : k
											.jqmData("mini")
								}, x), u = "ui-btn-inner", t = "ui-btn-text", v, r, m, s, p, w;
						f.each(j, function(o, y){
							n.setAttribute("data-" + f.mobile.ns + o, y);
							k.jqmData(o, y)
						});
						w = f
								.data((n.tagName === "INPUT" || n.tagName === "BUTTON" ? n.parentNode : n), "buttonElements");
						if(w){
							n = w.outer;
							k = f(n);
							m = w.inner;
						...
						if(j.iconpos && j.iconpos === "notext" && !k
								.attr("title")){
							k.attr("title", k.getEncodedText())
						}
						if(w){
				...
				function h(k){
					...
					while(k){
						...
						if(j && j.indexOf("ui-btn ") > -1 && j
								.indexOf("ui-disabled ") < 0){
							break
						}
						k = k.parentNode
					}
				...
				var e = function(){
					var k = f.mobile.buttonMarkup.hoverDelay, l, j;
					f(a)
							.bind({
								"vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart" : function(o){
									var p, n = f(h(o.target)), m = o.type;
									if(n.length){
										p = n
												.attr("data-" + f.mobile.ns + "theme");
										if(m === "vmousedown"){
											if(f.support.touch){
												l = setTimeout(function(){
													n
															.removeClass("ui-btn-up-" + p)
															.addClass("ui-btn-down-" + p)
												}, k)
											}
											else{
												n
											...
											if(m === "vmousecancel" || m === "vmouseup"){
												n
														.removeClass("ui-btn-down-" + p)
														.addClass("ui-btn-up-" + p)
											}
											else{
												if(m === "vmouseover" || m === "focus"){
													...
													if(m === "vmouseout" || m === "blur" || m === "scrollstart"){
														n
																.removeClass("ui-btn-hover-" + p + " ui-btn-down-" + p)
																.addClass("ui-btn-up-" + p);
														if(l){
															clearTimeout(l)
														}
								...
								"focusin focus" : function(m){
									f(h(m.target))
											.addClass(f.mobile.focusClass)
								},
								"focusout blur" : function(m){
									f(h(m.target))
											.removeClass(f.mobile.focusClass)
								}
							});
					e = null
				};
				f(a)
						.bind("pagecreate create", function(j){
							f(":jqmData(role='button'), .ui-bar > a, .ui-header > a, .ui-footer > a, .ui-bar > :jqmData(role='controlgroup') > a", j.target)
			...
			function(e, f){
				...
				e(a)
						.delegate(":jqmData(role='page'), :jqmData(role='dialog')", "pagecreate", function(k){
							var g = e(this), l = g.data("page").options, j = g
									.jqmData("role"), h = l.theme;
							e(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", this)
									.jqmEnhanceable()
									.each(function(){
										var r = e(this), n = r.jqmData("role"), o = r
												.jqmData("theme"), m = o || l.contentTheme || j === "dialog" && h, q, s, u, p;
										r.addClass("ui-" + n);
										if(n === "header" || n === "footer"){
											var t = o || (n === "header" ? l.headerTheme : l.footerTheme) || h;
											r
													.addClass("ui-bar-" + t)
													.attr("role", n === "header" ? "banner" : "contentinfo");
											if(n === "header"){
												q = r.children("a");
												...
												u = u || q
														.eq(1)
														.addClass("ui-btn-right").length
											}
											if(l.addBackBtn && n === "header" && e(".ui-page").length > 1 && g
													.jqmData("url") !== e.mobile.path
													.stripHash(location.hash) && !s){
												p = e("<a href='#' class='ui-btn-left' data-" + e.mobile.ns + "rel='back' data-" + e.mobile.ns + "icon='arrow-l'>" + l.backBtnText + "</a>")
														.attr("data-" + e.mobile.ns + "theme", l.backBtnTheme || t)
														.prependTo(r)
											}
											r
			...
			function(e, f){
				e
						.widget("mobile.collapsible", e.mobile.widget, {
							options : {
							...
							_create : function(){
								var j = this.element, l = this.options, k = j
										.addClass("ui-collapsible"), g = j
										.children(l.heading).first(), m = k
										.wrapInner("<div class='ui-collapsible-content'></div>")
										.find(".ui-collapsible-content"), h = j
										.closest(":jqmData(role='collapsible-set')")
										.addClass("ui-collapsible-set");
								if(g.is("legend")){
									g = e("<div role='heading'>" + g.html() + "</div>")
											.insertBefore(g);
									g.next().remove()
								}
								if(h.length){
									if(!l.theme){
										l.theme = h.jqmData("theme") || e.mobile
												.getInheritedTheme(h, "c")
									}
									if(!l.contentTheme){
										l.contentTheme = h
								...
								m
										.addClass(l.contentTheme ? "ui-body-" + l.contentTheme : "");
								g
										.insertBefore(m)
								...
								k
										.bind("expand collapse", function(o){
											if(!o.isDefaultPrevented()){
												o.preventDefault();
												var q = e(this), p = o.type === "collapse", n = l.contentTheme;
												g
														.toggleClass("ui-collapsible-heading-collapsed", p)
														.find(".ui-collapsible-heading-status")
														.text(p ? l.expandCueText : l.collapseCueText)
														.end()
														.find(".ui-icon")
														.toggleClass("ui-icon-minus", !p)
														.toggleClass("ui-icon-plus", p);
												q
														.toggleClass("ui-collapsible-collapsed", p);
												m
														.toggleClass("ui-collapsible-content-collapsed", p)
														.attr("aria-hidden", p);
												if(n && (!h.length || k
													...
													g
															...
															.add(g
																	.find(".ui-btn-inner"))
															.toggleClass("ui-corner-bottom", p);
													m
															.toggleClass("ui-corner-bottom", !p)
												}
			...
			function(e, f){
				e
						.widget("mobile.collapsibleset", e.mobile.widget, {
							options : {
								initSelector : ":jqmData(role='collapsible-set')"
							},
							_create : function(){
								var g = this.element
										.addClass("ui-collapsible-set"), h = this.options;
								if(!h.theme){
									h.theme = e.mobile
								...
								if(!g.jqmData("collapsiblebound")){
									g
											...
											.bind("expand collapse", function(l){
												var n = l.type === "collapse", k = e(l.target)
														.closest(".ui-collapsible"), m = k
														.data("collapsible"), j = m.options.contentTheme;
												if(j && k
														.jqmData("collapsible-last")){
													k
															.find(m.options.heading)
															.first()
															.find("a")
															.first()
															.add(".ui-btn-inner")
															.toggleClass("ui-corner-bottom", n);
													k
							...
							refresh : function(){
								var g = this.element, j = this.options, h = g
										.children(":jqmData(role='collapsible')");
								e.mobile.collapsible.prototype.enhance(h
										.not(".ui-collapsible"));
								h
										.each(function(){
											e(this)
													.find(e.mobile.collapsible.prototype.options.heading)
													.find("a")
													.first()
													.add(".ui-btn-inner")
								...
								h
										...
										.find("a")
										.first()
										.addClass(j.corners ? "ui-corner-top" : "")
										.find(".ui-btn-inner")
								...
								h
										...
										.find("a")
										.first()
										.addClass(j.corners ? "ui-corner-bottom" : "")
										.find(".ui-btn-inner")
										.addClass("ui-corner-bottom")
							}
						});
			...
			function(e, f){
				e
						.widget("mobile.navbar", e.mobile.widget, {
							options : {
								iconpos : "top",
								grid : null,
							...
							_create : function(){
								var j = this.element, g = j.find("a"), h = g
										.filter(":jqmData(icon)").length ? this.options.iconpos : f;
								j.addClass("ui-navbar")
										.attr("role", "navigation").find("ul")
										.jqmEnhanceable().grid({
			...
			function(e, g){
				var f = {};
				e
						.widget("mobile.listview", e.mobile.widget, {
							options : {
								theme : null,
								countTheme : "c",
								headerTheme : "b",
							...
							_removeCorners : function(h, k){
								var j = "ui-corner-top ui-corner-tr ui-corner-tl", l = "ui-corner-bottom ui-corner-br ui-corner-bl";
								h = h
										.add(h
							...
							_refreshCorners : function(k){
								...
								if(this.options.inset){
									...
									h
											...
											.addClass("ui-corner-tr").end()
											.find(".ui-li-thumb")
											.not(".ui-li-icon")
											.addClass("ui-corner-tl");
									l = j.last().addClass("ui-corner-bottom");
									l.add(l.find(".ui-btn-inner"))
											.find(".ui-li-link-alt")
											.addClass("ui-corner-br").end()
											.find(".ui-li-thumb")
											.not(".ui-li-icon")
							...
							_addThumbClasses : function(l){
								...
								for(k = 0; k < h; k++){
									j = e(this
											._findFirstElementByTagName(l[k].firstChild, "nextSibling", "img", "IMG"));
									if(j.length){
										j.addClass("ui-li-thumb");
										e(this
												._findFirstElementByTagName(j[0].parentNode, "parentNode", "li", "LI"))
												.addClass(j.is(".ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb")
									}
								}
							},
							refresh : function(w){
								...
								var A = this.options, h = this.element, z = this, E = h
										.jqmData("dividertheme") || A.dividerTheme, x = h
										.jqmData("splittheme"), p = h
										.jqmData("spliticon"), y = this
										._getChildrenByTagName(h[0], "li", "LI"), t = e.support.cssPseudoElement || !e
										.nodeName(h[0], "ol") ? 0 : 1, v = {}, C, j, u, D, s, m, k, B, q, F, n;
								if(t){
									h.find(".ui-li-dec").remove()
								}
								if(!A.theme){
									A.theme = e.mobile
											.getInheritedTheme(this.element, "c")
								}
								for(var r = 0, l = y.length; r < l; r++){
									...
									if(t && j.indexOf("ui-li-divider") < 0){
										k = C.is(".ui-li-static:first") ? C : C
												.find(".ui-link-inherit");
										k
												.addClass("ui-li-jsnumbering")
												.prepend("<span class='ui-li-dec'>" + t++ + ". </span>")
									}
									if(!v[j]){
										v[j] = []
									}
								...
								h
										...
										.addClass("ui-btn-up-" + (h
												.jqmData("counttheme") || this.options.countTheme) + " ui-btn-corner-all");
							...
							_createSubPages : function(){
								var r = this.element, s = r.closest(".ui-page"), j = s
										.jqmData("url"), m = j || s[0][e.expando], k = r
										.attr("id"), l = this.options, n = "data-" + e.mobile.ns, t = this, q = s
								...
								k = k || ++f[m];
								e(r.find("li>ul, li>ol").toArray().reverse())
										.each(function(y){
											var D = this, A = e(this), z = A
													.attr("id") || k + "-" + y, C = A
													.parent(), E = e(A
													.prevAll().toArray()
													.reverse()), E = E.length ? E : e("<span>" + e
													.trim(C.contents()[0].nodeValue) + "</span>"), B = E
													.first().getEncodedText(), o = (j || "") + "&" + e.mobile.subPageUrlKey + "=" + z, x = A
													.jqmData("theme") || l.theme, u = A
													.jqmData("counttheme") || r
													.jqmData("counttheme") || l.countTheme, v, w;
											h = true;
											v = A
													.detach()
													.wrap("<div " + n + "role='page' " + n + "url='" + o + "' " + n + "theme='" + x + "' " + n + "count-theme='" + u + "'><div " + n + "role='content'></div></div>")
													.parent()
													.before("<div " + n + "role='header' " + n + "theme='" + l.headerTheme + "'><div class='ui-title'>" + B + "</div></div>")
													.after(q ? e("<div " + n + "role='footer' " + n + "id='" + q + "'>") : "")
													.parent()
								...
								if(h && s.is(":jqmData(external-page='true')") && s
										.data("page").options.domCache === false){
									var p = function(w, v){
										var o = v.nextPage, u;
										if(v.nextPage){
											u = o.jqmData("url");
											if(u
													.indexOf(j + "&" + e.mobile.subPageUrlKey) !== 0){
												t.childPages().remove();
												s.remove()
											}
										}
									};
									s.unbind("pagehide.remove")
											.bind("pagehide.remove", p)
								}
							},
							childPages : function(){
			...
			function(e, f){
				e
						.widget("mobile.checkboxradio", e.mobile.widget, {
							options : {
								theme : null,
								initSelector : "input[type='checkbox'],input[type='radio']"
							},
							_create : function(){
								var x = this, t = this.element, o = function(y, z){
									return y.jqmData(z) || y
											.closest("form,fieldset")
											.jqmData(z)
								}, n = e(t).closest("label"), s = n.length ? n : e(t)
										.closest("form,fieldset,:jqmData(role='page'),:jqmData(role='dialog')")
										.find("label")
										.filter("[for='" + t[0].id + "']"), v = t[0].type, m = o(t, "mini"), w = v + "-on", u = v + "-off", q = t
										.parents(":jqmData(type='horizontal')").length ? f : u, p = o(t, "iconpos"), h = q ? "" : " " + e.mobile.activeBtnClass, l = "ui-" + w + h, k = "ui-" + u, r = "ui-icon-" + w, g = "ui-icon-" + u;
								...
								s
										.bind({
											...
											vclick : function(y){
												...
												x._cacheVals();
												t
														.prop("checked", v === "radio" && true || !t
																.prop("checked"));
												t.triggerHandler("click");
												x._getInputSet().not(t)
														.prop("checked", false);
												x._updateAll();
												return false
											}
							...
							refresh : function(){
								var g = this.element[0], h = this.label, j = h
										.find(".ui-icon");
								if(g.checked){
									h.addClass(this.checkedClass)
											.removeClass(this.uncheckedClass);
									j.addClass(this.checkedicon)
											.removeClass(this.uncheckedicon)
								}
								else{
									h.removeClass(this.checkedClass)
											.addClass(this.uncheckedClass);
									j.removeClass(this.checkedicon)
											.addClass(this.uncheckedicon)
								}
								if(g.disabled){
									this.disable()
								}
							...
							disable : function(){
								this.element.prop("disabled", true).parent()
				...
				e(a).bind("pagecreate create", function(g){
					e.mobile.checkboxradio.prototype
							.enhanceWithin(g.target, true)
				})
			}(jQuery);
			function(e, f){
				e
						.widget("mobile.button", e.mobile.widget, {
							options : {
								theme : null,
								icon : null,
								iconpos : null,
							...
							_create : function(){
								var j = this.element, m, n = this.options, k, g, h = "", l;
								if(j[0].tagName === "A"){
							...
							refresh : function(){
								...
								e(this.button.data("buttonElements").text)
										.text(g.text() || g.val())
							}
						});
				e(a).bind("pagecreate create", function(g){
			...
			function(e, f){
				e.fn.controlgroup = function(g){
					function h(k, j){
						k.removeClass("ui-btn-corner-all ui-shadow").eq(0)
								.addClass(j[0]).end().last().addClass(j[1])
							...
							.each(function(){
								var k = e(this), m = e
										.extend({
											...
											mini : k.jqmData("mini")
										}, g), n = k.children("legend"), j = m.direction == "horizontal" ? [
										"ui-corner-left", "ui-corner-right"] : [
										"ui-corner-top", "ui-corner-bottom"], l = k
										.find("input").first().attr("type");
								if(n.length){
									k
											.wrapInner("<div class='ui-controlgroup-controls'></div>");
									e("<div role='heading' class='ui-controlgroup-label'>" + n
											.html() + "</div>").insertBefore(k
											.children(0));
									n.remove()
								}
								k
										.addClass("ui-corner-all ui-controlgroup ui-controlgroup-" + m.direction);
								h(k
										.find(".ui-btn" + (m.excludeInvisible ? ":visible" : ""))
										.not(".ui-slider-handle"), j);
			...
			function(e, f){
				e(a)
						.bind("pagecreate create", function(g){
							e(g.target)
									.find("a")
									.jqmEnhanceable()
			...
			function(g){
				var h = g("meta[name=viewport]"), f = h.attr("content"), k = f + ",maximum-scale=1, user-scalable=no", j = f + ",maximum-scale=10, user-scalable=yes", e = /(user-scalable[\s]*=[\s]*no)|(maximum-scale[\s]*=[\s]*1)[$,\s]/
						.test(f);
			...
			function(e, f){
				e
						.widget("mobile.textinput", e.mobile.widget, {
							options : {
								theme : null,
								preventFocusZoom : /iPhone|iPad|iPod/
										.test(navigator.platform) && navigator.userAgent
										.indexOf("AppleWebKit") > -1,
								initSelector : "input[type='text'], input[type='search'], :jqmData(type='search'), input[type='number'], :jqmData(type='number'), input[type='password'], input[type='email'], input[type='url'], input[type='tel'], textarea, input[type='time'], input[type='date'], input[type='month'], input[type='week'], input[type='datetime'], input[type='datetime-local'], input[type='color'], input:not([type])",
								clearSearchButtonText : "clear text"
							},
							_create : function(){
								var r = this.element, j = this.options, l = j.theme || e.mobile
										.getInheritedTheme(this.element, "c"), u = " ui-body-" + l, p = r
										.jqmData("mini") == true, n = p ? " ui-mini" : "", m, s;
								e("label[for='" + r.attr("id") + "']")
								...
								if(r
									...
									m = r
											.wrap("<div class='ui-input-search ui-shadow-inset ui-btn-corner-all ui-btn-shadow ui-icon-searchfield" + u + n + "'></div>")
											.parent();
									s = e("<a href='#' class='ui-input-clear' title='" + j.clearSearchButtonText + "'>" + j.clearSearchButtonText + "</a>")
											.bind("click", function(o){
												r.val("").focus()
														.trigger("change");
												s
									...
									function h(){
										setTimeout(function(){
											s
													.toggleClass("ui-input-clear-hidden", !r
															.val())
										}, 0)
									}
									h();
									r
											.bind("paste cut keyup focus change blur", h)
								}
								else{
									r
											.addClass("ui-corner-all ui-shadow-inset" + u + n)
								}
								r.focus(function(){
									m.addClass(e.mobile.focusClass)
								}).blur(function(){
								...
								if(r.is("textarea")){
									var k = 15, q = 100, g = function(){
										var v = r[0].scrollHeight, o = r[0].clientHeight;
										if(o < v){
											r.height(v + k)
										}
									}, t;
							...
							disable : function(){
								(this.element
										.attr("disabled", true)
										.is("[type='search'],:jqmData(type='search')") ? this.element
										.parent() : this.element)
										.addClass("ui-disabled")
							},
							enable : function(){
			...
			function(e, f){
				...
				e(a)
						.delegate(":jqmData(role='listview')", "listviewcreate", function(){
							var j = e(this), h = j.data("listview");
							if(!h.options.filter){
								return
							}
							var k = e("<form>", {
								...
								placeholder : h.options.filterPlaceholder
									...
									.attr("data-" + e.mobile.ns + "type", "search")
									.jqmData("lastval", "")
									.bind("keyup change", function(){
										var p = e(this), r = this.value
												.toLowerCase(), o = null, s = p
												.jqmData("lastval") + "", q = false, m = "", n;
										p.jqmData("lastval", r);
										...
										if(r){
											for(var l = o.length - 1; l >= 0; l--){
												n = e(o[l]);
												m = n.jqmData("filtertext") || n
														.text();
												if(n
														.is("li:jqmData(role=list-divider)")){
													n
															.toggleClass("ui-filter-hidequeue", !q);
													q = false
												}
												else{
													if(h.options
															.filterCallback(m, r)){
														n
																.toggleClass("ui-filter-hidequeue", true)
													}
													else{
														q = true
													}
			...
			function(e, f){
				e
						.widget("mobile.slider", e.mobile.widget, {
							options : {
								theme : null,
								trackTheme : null,
								disabled : false,
							...
							_create : function(){
								var u = this, r = this.element, z = e.mobile
										.getInheritedTheme(r, "c"), J = this.options.theme || z, w = this.options.trackTheme || z, s = r[0].nodeName
										.toLowerCase(), G = s == "select" ? "ui-slider-switch" : "", m = r
										.attr("id"), t = m + "-label", q = e("[for='" + m + "']")
										.attr("id", t), M = function(){
									return s == "input" ? parseFloat(r.val()) : r[0].selectedIndex
								}, y = s == "input" ? parseFloat(r.attr("min")) : 0, C = s == "input" ? parseFloat(r
										.attr("max")) : r.find("option").length - 1, p = b
										.parseFloat(r.attr("step") || 1), v = this.options.inline || r
										.jqmData("inline") == true ? " ui-slider-inline" : "", K = this.options.mini || r
										.jqmData("mini") ? " ui-slider-mini" : "", H = a
										.createElement("a"), I = e(H), g = a
										.createElement("div"), x = e(g), F = r
										.jqmData("highlight") && s != "select" ? function(){
									var j = a.createElement("div");
								...
								g.className = ["ui-slider ", G,
										" ui-btn-down-", w,
										" ui-btn-corner-all", v, K].join("");
								...
								if(s == "select"){
									...
									for(var B = 0, L = l.length; B < L; B++){
										var h = !B ? "b" : "a", o = !B ? " ui-btn-down-" + w : " " + e.mobile.activeBtnClass, E = a
												.createElement("div"), D = a
												.createElement("span");
										D.className = [
												"ui-slider-label ui-slider-label-",
												h, o, " ui-btn-corner-all"]
												.join("");
										D.setAttribute("role", "img");
										D
												.appendChild(a
														.createTextNode(l[B].innerHTML));
										e(D).prependTo(x)
									}
								...
								r
										.addClass(s === "input" ? "ui-slider-input" : "ui-slider-switch")
										.change(function(){
											if(!u.mouseMoved){
												u.refresh(M(), true)
											}
											...
											if(u.dragging){
												...
												if(s === "select"){
													...
													if(u.mouseMoved){
														if(u.userModified){
															u
																	.refresh(u.beforeStart == 0 ? 1 : 0)
														}
														else{
															u
																	.refresh(u.beforeStart)
														}
													}
													else{
														u
							...
							refresh : function(y, w, n){
								...
								var o = this.element, h, p = o[0].nodeName
										.toLowerCase(), t = p === "input" ? parseFloat(o
										.attr("min")) : 0, v = p === "input" ? parseFloat(o
										.attr("max")) : o.find("option").length - 1, l = p === "input" && parseFloat(o
										.attr("step")) > 0 ? parseFloat(o
										.attr("step")) : 1;
								if(typeof y === "object"){
									var x = y, r = 8;
									if(!this.dragging || x.pageX < this.slider
											.offset().left - r || x.pageX > this.slider
											.offset().left + this.slider
											.width() + r){
										return
									}
									h = Math.round((x.pageX - this.slider
											.offset().left) / this.slider
											.width() * 100)
								}
								else{
								...
								this.handle
										.attr({
											"aria-valuenow" : p === "input" ? q : o
													.find("option").eq(q)
													.attr("value"),
											"aria-valuetext" : p === "input" ? q : o
													.find("option").eq(q)
													.getEncodedText(),
											title : p === "input" ? q : o
													.find("option").eq(q)
								...
								this.valuebg && this.valuebg
										.css("width", h + "%");
								if(this._labels){
									var s = this.handle.width() / this.slider
											.width() * 100, g = h && s + (100 - s) * h / 100, j = h === 100 ? 0 : Math
											.min(s + 100 - g, 100);
									this._labels.each(function(){
										var z = e(this)
												.is(".ui-slider-label-a");
										e(this).width((z ? g : j) + "%")
									})
								}
								if(!n){
							...
							enable : function(){
								this.element.attr("disabled", false);
								this.slider.removeClass("ui-disabled")
										.attr("aria-disabled", false);
								return this._setOption("disabled", false)
							},
							disable : function(){
			...
			function(e, f){
				e
						.widget("mobile.selectmenu", e.mobile.widget, {
							options : {
								theme : null,
								disabled : false,
								icon : "arrow-d",
							...
							_preExtension : function(){
								...
								if(!this.options.theme){
									this.options.theme = e.mobile
											.getInheritedTheme(this.select, "c")
								}
							},
							_create : function(){
								this._preExtension();
								...
								var h = this, j = this.options, g = this.select[0].selectedIndex == -1 ? 0 : this.select[0].selectedIndex, k = this.button
										.text(e(this.select[0].options.item(g))
												.text())
							...
							build : function(){
								...
								this.select
										...
										.bind("focus", function(){
											g.button
													.addClass(e.mobile.focusClass)
										})
										.bind("blur", function(){
											g.button
													.removeClass(e.mobile.focusClass)
										})
										...
										.bind("change blur", function(){
											g.button
													.removeClass("ui-btn-down-" + g.options.theme)
										});
							...
							setButtonCount : function(){
								var g = this.selected();
								if(this.isMultiple){
									this.buttonCount[g.length > 1 ? "show" : "hide"]
											().text(g.length)
								}
							},
							refresh : function(){
			...
			function(f, g){
				var e = function(o){
					var u = o.select, y = o.selectID, r = o.label, h = o.select
							.closest(".ui-page"), k = f("<div>", {
						"class" : "ui-selectmenu-screen ui-screen-hidden"
					}).appendTo(h), w = o._selectOptions(), n = o.isMultiple = o.select[0].multiple, q = y + "-button", s = y + "-menu", t = f("<div data-" + f.mobile.ns + "role='dialog' data-" + f.mobile.ns + "theme='" + o.options.theme + "' data-" + f.mobile.ns + "overlay-theme='" + o.options.overlayTheme + "'><div data-" + f.mobile.ns + "role='header'><div class='ui-title'>" + r
							.getEncodedText() + "</div></div><div data-" + f.mobile.ns + "role='content'></div></div>"), j = f("<div>", {
					...
					}).insertAfter(k), z = f("<ul>", {
						"class" : "ui-selectmenu-list",
						id : s,
						role : "listbox",
						"aria-labelledby" : q
					}).attr("data-" + f.mobile.ns + "theme", o.options.theme)
							.appendTo(j), x = f("<div>", {
					...
					if(o.isMultiple){
						p = f("<a>", {
							...
							href : "#",
							"class" : "ui-btn-left"
						}).attr("data-" + f.mobile.ns + "iconpos", "notext")
								.attr("data-" + f.mobile.ns + "icon", "delete")
								.appendTo(x).buttonMarkup()
					}
					f
							.extend(o, {
								select : o.select,
								...
								build : function(){
									var A = this;
									A.refresh();
									A.select.attr("tabindex", "-1")
											.focus(function(){
												f(this).blur();
												A.button.focus()
											});
									A.button
											.bind("vclick keydown", function(B){
									...
									A.list
											...
											.delegate("li:not(.ui-disabled, .ui-li-divider)", "click", function(D){
												var E = A.select[0].selectedIndex, B = A.list
														.find("li:not(.ui-li-divider)")
														.index(this), C = A
														._selectOptions().eq(B)[0];
												C.selected = A.isMultiple ? !C.selected : true;
												if(A.isMultiple){
													f(this)
															.find(".ui-icon")
															.toggleClass("ui-icon-checkbox-on", C.selected)
															.toggleClass("ui-icon-checkbox-off", !C.selected)
												}
												if(A.isMultiple || E !== B){
											...
											.keydown(function(E){
												var F = f(E.target), B = F
														.closest("li"), D, C;
												switch(E.keyCode){
													case 38:
														D = B
																.prev()
																.not(".ui-selectmenu-placeholder");
														if(D
																.is(".ui-li-divider")){
															D = D.prev()
														}
														if(D.length){
															F
																	...
																	.attr("tabindex", "-1");
															D
																	.addClass("ui-btn-down-" + o.options.theme)
																	.find("a")
																	.first()
																	.focus()
														}
								...
								_isRebuildRequired : function(){
									var B = this.list.find("li"), A = this
											._selectOptions();
									return A.text() !== B.text()
								},
								refresh : function(E, H){
									var B = this, A = this.element, F = this.isMultiple, C = this
											._selectOptions(), D = this
											.selected(), G = this
											.selectedIndices();
												...
												if(f.inArray(I, G) > -1){
													...
													if(B.isMultiple){
														...
														if(J
															...
															J
																	.next()
																	.addClass(f.mobile.activeBtnClass)
														}
														else{
															J
																	.addClass(f.mobile.activeBtnClass)
								...
								open : function(){
									...
									var L = this, J = f(b), H = L.list.parent(), M = H
											.outerHeight(), C = H.outerWidth(), Q = f(".ui-page-active"), A = Q, E = J
											.scrollTop(), O = L.button.offset().top, R = J
											.height(), P = J.width();
									...
									function N(){
										L.list
												.find("." + f.mobile.activeBtnClass + " a")
												.focus()
									}
									if(M > R - 80 || !f.support.scrollTop){
										L.menuPage
												.appendTo(f.mobile.pageContainer)
												.page();
										L.menuPageContent = t
												.find(".ui-content");
										L.menuPageClose = t
										...
										L.menuPage.find("div .ui-title")
												.text(L.label.text());
										f.mobile
												.changePage(L.menuPage, {
										...
										var D = O - E, B = E + R - O, G = M / 2, K = parseFloat(L.list
												.parent().css("max-width")), F, I;
										if(D > M / 2 && B > M / 2){
										...
										if(C < K){
											...
											I = L.button.offset().left + L.button
													.outerWidth() / 2 - C / 2;
											if(I < 30){
												I = 30
											}
								...
								_buildList : function(){
									var L = this, Q = this.options, D = this.placeholder, C = true, T = [], A = [], G = L.isMultiple ? "checkbox-off" : "false";
									L.list.empty().filter(".ui-listview")
											.listview("destroy");
									var R = L.select.find("option"), I = R.length, P = this.select[0], Y = "data-" + f.mobile.ns, U = Y + "option-index", Z = Y + "icon", E = Y + "role", B = a
											.createDocumentFragment(), N;
									for(var V = 0; V < I; V++){
										var K = R[V], S = f(K), H = K.parentNode, J = S
												.text(), F = a
												.createElement("a"), X = [];
										F.setAttribute("href", "#");
										...
										if(C && (!K.getAttribute("value") || J.length == 0 || S
												.jqmData("placeholder"))){
											C = false;
			...
			function(e, f){
				e
						.widget("mobile.fixedtoolbar", e.mobile.widget, {
							options : {
								...
								supportBlacklist : function(){
									var p = b, h = navigator.userAgent, k = navigator.platform, o = h
											.match(/AppleWebKit\/([0-9]+)/), n = !!o && o[1], j = h
											.match(/Fennec\/([0-9]+)/), l = !!j && j[1], m = h
											.match(/Opera Mobi\/([0-9]+)/), g = !!m && m[1];
									if((k.indexOf("iPhone") > -1 || k
											.indexOf("iPad") > -1 || k
											.indexOf("iPod") > -1) && n && n < 534 || p.operamini && {}.toString
											.call(p.operamini) === "[object OperaMini]" || m && g < 7458 || h
											.indexOf("Android") > -1 && n && n < 533 || l && l < 6 || "palmGetResource" in b && n && n < 534 || h
											.indexOf("MeeGo") > -1 && h
							...
							_create : function(){
								var g = this, l = g.options, j = g.element, k = j
										.is(":jqmData(role='header')") ? "header" : "footer", h = j
										.closest(".ui-page");
							...
							_bindPageEvents : function(){
								var g = this, j = g.options, h = g.element;
								h
										.closest(".ui-page")
										.bind("pagebeforeshow", function(){
										...
										.bind("pageshow", function(){
											...
											if(j.updatePagePadding){
												e(b)
														.bind("throttledresize." + g.widgetName, function(){
															g
																	.updatePagePadding()
														})
											}
										...
										.bind("pagebeforehide", function(n, m){
											...
											if(j.updatePagePadding){
												e(b)
														.unbind("throttledresize." + g.widgetName)
											}
											if(j.trackPersistentToolbars){
												var p = e(".ui-footer-fixed:jqmData(id)", this), o = e(".ui-header-fixed:jqmData(id)", this), l = p.length && m.nextPage && e(".ui-footer-fixed:jqmData(id='" + p
														.jqmData("id") + "')", m.nextPage), k = o.length && m.nextPage && e(".ui-header-fixed:jqmData(id='" + o
														.jqmData("id") + "')", m.nextPage);
												l = l || e();
							...
							updatePagePadding : function(){
								var g = this.element, h = g.is(".ui-header");
								if(this.options.fullscreen){
									return
								}
								g
										.closest(".ui-page")
										.css("padding-" + (h ? "top" : "bottom"), g
												.outerHeight())
							},
							_useTransition : function(l){
								var o = e(b), k = this.element, g = o
										.scrollTop(), h = k.height(), n = k
										.closest(".ui-page").height(), j = e.mobile
										.getScreenHeight(), m = k
										.is(":jqmData(role='header')") ? "header" : "footer";
							...
							show : function(h){
								var j = "ui-fixed-hidden", g = this.element;
							...
							hide : function(h){
								var k = "ui-fixed-hidden", g = this.element, j = "out" + (this.options.transition === "slide" ? " reverse" : "");
								if(this._useTransition(h)){
									g.addClass(j).removeClass("in")
							...
							_bindToggleHandlers : function(){
								...
								h
										...
										.bind("vclick", function(k){
											if(j.tapToggle && !e(k.target)
													.closest(j.tapToggleBlacklist).length){
												g.toggle()
											}
										})
										.bind("focusin focusout", function(k){
											if(screen.width < 500 && e(k.target)
													.is(j.hideDuringFocus) && !e(k.target)
				...
				e(a)
						.bind("pagecreate create", function(g){
							if(e(g.target).jqmData("fullscreen")){
								e(e.mobile.fixedtoolbar.prototype.options.initSelector, g.target)
										.not(":jqmData(fullscreen)")
										.jqmData("fullscreen", true)
							}
							e.mobile.fixedtoolbar.prototype
									.enhanceWithin(g.target)
						})
			}(jQuery);
			function(g, h){
				if(!(/iPhone|iPad|iPod/.test(navigator.platform) && navigator.userAgent
						.indexOf("AppleWebKit") > -1)){
					return
				}
				var n = g.mobile.zoom, m, l, k, j, e;
				function f(o){
					m = o.originalEvent;
				...
				g(h).bind("orientationchange.iosorientationfix", n.enable)
						.bind("devicemotion.iosorientationfix", f)
			}(jQuery, this);
			function(l, m, g){
				var j = l("html"), n = l("head"), f = l(m);
				...
				setTimeout(p, 5000);
				var h = "ui-loader", k = l("<div class='" + h + "'><span class='ui-icon ui-icon-loading'></span><h1></h1></div>");
				function e(){
					var q = l("." + l.mobile.activeBtnClass).first();
					k
							.css({
								top : l.support.scrollTop && f.scrollTop() + f
										.height() / 2 || q.length && q.offset().top || 100
							})
				}
				function o(){
					var r = k.offset(), q = f.scrollTop(), s = l.mobile
							.getScreenHeight();
						...
						.extend(l.mobile, {
							showPageLoadingMsg : function(s, q, t){
								...
								if(l.mobile.loadingMessage){
									...
									s = s || l.mobile.loadingMessageTheme, k
											.attr("class", h + " ui-corner-all ui-body-" + (s || "a") + " ui-loader-" + (r ? "verbose" : "default") + (t ? " ui-loader-textonly" : ""))
											.find("h1")
											.text(q || l.mobile.loadingMessage)
											.end()
											.appendTo(l.mobile.pageContainer);
									o();
									f.bind("scroll", o)
								}
							},
							...
							initializePage : function(){
								...
								if(!q.length){
									q = l("body")
											.wrapInner("<div data-" + l.mobile.ns + "role='page'></div>")
											.children(0)
								}
								q
										.each(function(){
											...
											if(!r.jqmData("url")){
												r
														.attr("data-" + l.mobile.ns + "url", r
																.attr("id") || location.pathname + location.search)
											}
										});
								l.mobile.firstPage = q.first();
								l.mobile.pageContainer = q.first().parent()
										.addClass("ui-mobile-viewport");
								f.trigger("pagecontainercreate");
								l.mobile.showPageLoadingMsg();
								p();
								if(!l.mobile.hashListeningEnabled || !l.mobile.path
				...
				l(function(){
					m.scrollTo(0, 1);
					l.mobile.defaultHomeScroll = !l.support.scrollTop || l(m)
							.scrollTop() === 1 ? 0 : 1;
					if(l.fn.controlgroup){
						l(a).bind("pagecreate create", function(q){
							l(":jqmData(role='controlgroup')", q.target)
									.jqmEnhanceable().controlgroup({
